...
STOP_WORDS = {
    ...
    'than', 'too', 'very', 'can', 'just', 'should', 'now', 'using'
}
...
def cleanup_history(
    ...
    history['rejections'] = [
        r for r in history.get('rejections', [])
