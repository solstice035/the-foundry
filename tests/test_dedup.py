...
class TestDuplicateDetection(unittest.TestCase):
    ...
    def test_high_similarity_duplicate(self):
        ...
        result = is_duplicate(
            "PDF merge split and privacy tool for browsers", self.history
        )
        self.assertIsNotNone(result)
        self.assertTrue(result["is_duplicate"])
    ...
    def test_threshold_adjustment(self):
        ...
        is_duplicate("PDF merge tool", self.history, threshold=0.7)
...
class TestHistoryUpdates(unittest.TestCase):
    ...
    def test_add_rejection(self):
        ...
        self.assertEqual(
            history["rejections"][0]["title"], "Political polling dashboard"
        )
        # Keywords should be auto-generated
